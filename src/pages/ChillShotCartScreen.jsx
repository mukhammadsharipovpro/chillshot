...
import ChillShotCartItemComponent from '../components/ChillShotCartItemComponent';
import ChillShotComponent from '../components/ChillShotComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <ChillShotCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
